    ...
    if(goods.length) {
        ...
        for(let i=0; i<goods.length; i++) {
            ...
            <tr class="align-middle">
                ...
                <td>${goods[i][3]}</td>
                <td><button class="good_delete btn-danger" data-delete="${goods[i][0]}">&#10006</button></td>
                <td><button class="good_delete btn-PRIMARY" data-goods="${goods[i][0]}">&#10149</button></td>
            </tr>
            `
            )
            if(goods[i][4]>0) {
            ...
            <tr class="align-middle">
                ...
                <td class="price_discount"><input data-good id="${goods[i][0]}" type="text" value="${goods[i][5]}" min="0" max="100"></td>
                <td>${goods[i][6]}</td>
                <td><button class="good_delete btn-danger" data-delete="${goods[i][0]}">&#10006</button></td>
